...
const columns = [
  ...
  { title: '证件详情', dataIndex: 'address', key: '6', width: 150 ,align: 'center' },
  ...
  render() {
    ...
    return (
      <div className = 'info'>
        ...
        <Table rowSelection={rowSelection} columns={columns} dataSource={data} scroll={{ x: 1800 }} pagination = {{ defaultPageSize:15 }}/>
      </div>
    )
  }
}
