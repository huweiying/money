      ...
      <div className = 'msg'>
        ...
        <div className = 'navIndex'>
          <div  className = 'clean row'>
            ...
            <NavLink to='/print/prove' onClick = {()=>{this.props.handleNav(2)}}><img src={require('../../assets/img/print.png')}/>打印审核</NavLink>
            <NavLink to='/charge/save' onClick = {()=>{this.props.handleNav(3)}}><img src={require('../../assets/img/coast.png')}/>收费管理</NavLink>
          </div>
          <div className = 'clean row'>
